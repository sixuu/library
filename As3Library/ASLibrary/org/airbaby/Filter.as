package org.airbaby
{
	...
	public class Filter
	{
		...
		public static function invert(bmpSource:BitmapData):BitmapData
		{
			sourceBitmap = new Bitmap(bmpSource);
		...
		public static function raiseFilter(source:BitmapData,distance=5,angleInDegrees=45):BitmapData
		{
		...
		public static function reflection(bd:BitmapData):BitmapData
		{
